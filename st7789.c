...
void ST7789_Init(void)
{
	...
	/* Actually settings below are unnecessary... */
...
void ST7789_Test(void)
{
	...
	ST7789_WriteString(10, 20, "Hello Steve!", Font_7x10, RED, WHITE);
	ST7789_WriteString(10, 50, "Hello Steve!", Font_11x18, YELLOW, WHITE);
	ST7789_WriteString(10, 80, "Hello Steve!", Font_16x26, MAGENTA, WHITE);
	HAL_Delay(1000);
	ST7789_Fill_Color(RED);
	ST7789_DrawRectangle(20, 20, 80, 80, WHITE);
	HAL_Delay(500);
